...
# select date range
#start_date = '2011-04-28' # from 2011-04-23
...
#end_date = '2011-04-19' # to 2011-05-01

# REDD house 6 range
#start_date = '2011-05-22' # from 2011-04-23
#end_date = '2011-05-23' # to 2011-05-01
...
signature_database = "../Data/REFIT/signatures/signature_house_8.csv" #the signatures were extracted of power analysis from April 28th to 30th
...
print("Time elapsed: %d min %d sec" %(m, s))
...
#plt.plot(gsp_result.index, gsp_result.ix[:,24], label = gsp_result.ix[:,24].name)
